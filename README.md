...
- Interested in making my device use the least amount of resource but still usable and just works, that's why I use Linux now.
- Dual booted Linux because I was bored and not satisfied with Windows and my laptop (because it keeps getting hot even on idle (I maybe need to get it check out XD)), I even wanted to reinstall Windows with the "bloatless way" so it could run better but we'll see. After distro hopping from Mint, Endeavour, Manjaro, PopOS!, Fedora, and Arch and tried some desktop environments GNOME, KDE, XFCE, LXQT, LXDE, and Cinnamon and some window managers AwesomeWM, QTile, i3, and Sway.  I finally settled on Arch with i3 (I chose Arch because, I think, it is quite minimal (even though you can actually get similar results by installing other distros minimal ISO), it has the AUR and the Arch wiki,👍 and I use archinstall, btw, making it easy for me to install arch. And I chose i3 because it is a tiling window manager and is easy to configure. After that, it's all a journey 😄) (you can see a bit of my dotfiles and screenshots of my desktop [here](https://github.com/ananda17gb/MyDotfiles)) (may change in the future XD, edited on 10/Sep/24).
- Have been making sh**ty music since semester 2 of 8th grade (you can check some of my music on my [Soundcloud](https://soundcloud.com/ndaaw), [My Music Display](https://anandamusicdisplay.vercel.app/) and also on my [Instagram](https://instagram.com/anandaaw17)).
- I love VSRGs such as [osu! ("NdaAW")](https://osu.ppy.sh/users/17126049), [Quaver ("NdaAW")](https://quavergame.com/user/151835), Etterna, and Roblox's Funky Friday ("realNdaAW").
